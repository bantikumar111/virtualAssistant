...
const geminiResponse= async (command, assistantName, userName)=>{
  try {
...

    {
      ...
      aur agar koi aisa question puchhta hai jiska answer tumhe pata ho to usko bhi general ki category me rakho bas short answer dena.
...
//take prompt by user and give response